...
* Use [GitHub](https://www.github.com) for creating a reproducible research document.

    * My GitHub username is: *SehyunLee0911*
...
The second line of output is printed out instead, but this means that the caculated value has not been saved for future use.
